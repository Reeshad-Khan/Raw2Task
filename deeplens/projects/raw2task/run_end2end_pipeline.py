...
from deeplens.projects.raw2task.curate_paper_figures import curate as curate_story_figures
from deeplens.projects.raw2task.animate_camera_learning import make_learning_gifs
from deeplens.projects.raw2task.run_review_matrix import run_matrix
...
def run_robustness(
    ...
    for row in summary_rows:
        ...
        cmd = [
            sys.executable,
            "-m",
            "deeplens.projects.raw2task.eval_robustness",
            "--ckpt",
            ckpt,
            "--out-dir",
            out_dir,
