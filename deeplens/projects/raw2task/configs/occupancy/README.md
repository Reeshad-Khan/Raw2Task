...
```bash
python -m deeplens.projects.raw2task.occupancy.kitti360_builder \
...
```bash
python -m deeplens.projects.raw2task.occupancy.validate_assets \
...
```bash
python -m deeplens.projects.raw2task.occupancy.train_occupancy \
