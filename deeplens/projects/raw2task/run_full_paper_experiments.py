...
from deeplens.projects.raw2task.run_paper_experiments import _detect_gpus
...
def _prepare_occupancy_assets(args: argparse.Namespace) -> None:
    ...
    if args.skip_occupancy_build and train_manifest.is_file() and val_manifest.is_file():
        ...
        build_cmd = [
            ...
            "-u",
            "-m",
            "deeplens.projects.raw2task.occupancy.kitti360_builder",
            "--root",
            args.kitti_root,
            "--out-root",
    ...
    validate_cmd = [
        ...
        "-u",
        "-m",
        "deeplens.projects.raw2task.occupancy.validate_assets",
        "--root",
        args.occupancy_out_root,
        "--manifest",
        str(val_manifest),
...
def _launch_occ(job: OccJob, gpu: str, python_bin: str, label: str = "occupancy") -> RunningOccJob:
    ...
    cmd = [
        ...
        "-u",
        "-m",
        "deeplens.projects.raw2task.occupancy.train_occupancy",
        "--config",
        job.config_path,
    ]
